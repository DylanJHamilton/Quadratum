...
def family(name):
 ...
 if name in ['qtm-content-block-wrapper-end', 'qtm-content-block-wrapper-start', 'qtm-content-blocks', 'qtm-content-blocks-engine', 'qtm-product-block-metadata', 'qtm-product-block-commerce', 'qtm-product-block-data', 'qtm-product-block-variant', 'qtm-product-information-value']:return '8 Theme Blocks'
