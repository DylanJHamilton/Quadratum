...
def family(name):
 ...
 if name in ['qtm-content-block-wrapper-end', 'qtm-content-block-wrapper-start', 'qtm-content-blocks', 'qtm-content-blocks-engine', 'qtm-product-block-metadata']:return '8 Theme Blocks'
