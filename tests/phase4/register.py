...
def family(name):
 ...
 if name in ['qtm-content-block-wrapper-end', 'qtm-content-block-wrapper-start', 'qtm-content-blocks', 'qtm-content-blocks-engine', 'qtm-product-block-metadata', 'qtm-product-block-commerce', 'qtm-product-block-data', 'qtm-product-block-variant', 'qtm-product-information-value', 'qtm-block-metafield', 'qtm-block-panels', 'qtm-block-deadline', 'qtm-product-block-utilities', 'qtm-block-product-media', 'qtm-product-block-gallery', 'qtm-block-product-card', 'qtm-block-product-cards', 'qtm-block-bundle-item', 'qtm-block-bundles', 'qtm-block-navigation', 'qtm-block-comparison-value', 'qtm-block-location-info', 'qtm-block-visual-media', 'qtm-block-collection-card', 'qtm-block-featured-product-gallery']:return '8 Theme Blocks'
